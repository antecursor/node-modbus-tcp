...
function Client() {
	...
	addReadFileFunction(this, "readFileRecord", writer, responses);
...
function addReadFileFunction(obj, name, writer, responses) {
	obj[name] = function (unitId, subRequests, next) {
		if (typeof next == "function") {
			responses[obj.transactionId] = { next: next };
		}

		writer.write(functions[name](obj.transactionId, unitId, subRequests));
